...
public class HorarioDoctorServiceImpl implements IHorarioDoctorService {
    ...
    public void validacionFechaYHora(int doctorId, HorarioDoctorRequest horarioDoctor){
        List<HorarioDoctor> hora = horarioDoctorRepository.findByDoctorIdAndHoraInicioAndHoraFin(doctorId,horarioDoctor.getHoraInicio(),horarioDoctor.getHoraFin());
        ...
        if(!hora.isEmpty()){
            throw new HandlerDateTimeException("La hora ya existe");
        }
    }
}
